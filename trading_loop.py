...
from utils.shared_state import update_bot_state  # New import
import time
...
async def trading_loop(balance, pairs, poll_interval):
    ...
    while True:
        ...
        update_bot_state({
            ...
            "price_history": bot_state.get("price_history", []) + [{"time": time.time(), "price": sol_price}]  # Append for charting
        })
